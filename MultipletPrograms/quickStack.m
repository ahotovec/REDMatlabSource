function [Sc]=quickStack(Sc,opt) 

%This is a near-copy of stackSubRaClusters, but I have removed the
%sub-sample stacking and other stuff that was taking an eternity to run
%-Kate
...
for k = 1:size(Sc,1)
    ...
    if length(opt.bpfilt)==2
        ...
        Sc{k}=coralFilter(Sc{k},opt.bpfilt,'bandpass',2,'minimum');
